...
String read_accelerometer(){
  double x = -1000000, y = -1000000 , z = -1000000; //dumb values, easy to spot problem
  sensors_event_t accelerometerData;
  bno.getEvent(&accelerometerData, Adafruit_BNO055::VECTOR_ACCELEROMETER);
  x = accelerometerData.gyro.x;
	y = accelerometerData.gyro.y;
	z = accelerometerData.gyro.z;
...
String read_gravity(){
  ...
  x = gravityData.gyro.x;
	y = gravityData.gyro.y;
	z = gravityData.gyro.z;
...
String serial_read_orientation(){
  double x = -1000000, y = -1000000 , z = -1000000; //dumb values, easy to spot problem
  sensors_event_t orientationData;
  bno.getEvent(&orientationData, Adafruit_BNO055::VECTOR_EULER);
...
String serial_read_angular_velocity(){
  double x = -1000000, y = -1000000 , z = -1000000; //dumb values, easy to spot problem
  sensors_event_t angVelocityData;
  bno.getEvent(&angVelocityData, Adafruit_BNO055::VECTOR_GYROSCOPE);
...
String serial_read_magnetometer(){
  double x = -1000000, y = -1000000 , z = -1000000; //dumb values, easy to spot problem
  sensors_event_t magnetometerData;
  bno.getEvent(&magnetometerData, Adafruit_BNO055::VECTOR_MAGNETOMETER);
  x = magnetometerData.magnetic.x;
...
String serial_read_accelerometer(){
  double x = -1000000, y = -1000000 , z = -1000000; //dumb values, easy to spot problem
  sensors_event_t accelerometerData;
  bno.getEvent(&accelerometerData, Adafruit_BNO055::VECTOR_ACCELEROMETER);
  x = accelerometerData.gyro.x;
